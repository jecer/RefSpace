...
ipcMain.handle('save-project', async (event, data, existingPath, dialogTitle) => {
...
ipcMain.handle('open-project', async (event, dialogTitle) => {
...
ipcMain.handle('open-project-from-path', async (event, filePath) => {
  try {
